...
- 根目录首页：负责显示“进入 Hello World”，尝试唤起本机桌面程序；如果没有检测到打开成功，就显示下载兜底。
...
这里检测的是“页面有没有切走”，不是系统级安装状态。用户如果一直不点击浏览器的“打开 hello-world://open”确认框，页面也可能进入下载兜底。
